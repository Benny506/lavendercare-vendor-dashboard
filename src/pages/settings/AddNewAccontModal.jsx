                        ...
                        >
                            <div className="flex flex-col gap-4">
                                <div className="mb-5">
                                    ...
                                    <Badge className="bg-success-50 text-success-700 mb-2 w-full rounded-4xl justify-start items-center py-1.5">
                                        <Icon icon="ei:check" width="20" height="20" />
                                        {user.email}
                                    </Badge>

                                    <Badge className={`${phoneNoSet ? 'bg-success-50 text-success-700' : 'bg-error-50 text-error-700'} w-full rounded-4xl justify-start items-center py-1.5`}>
                                        {
                                            phoneNoSet
                                                ?
                                                <Icon icon="ei:check" width="20" height="20" />
